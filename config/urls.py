...
urlpatterns = [
    ...
    path('', IndexView.as_view(), name='index'), #b.o
    ...
    path('fazer-reserva/<int:livro_id>/', FazerReservaView.as_view(), name='fazer_reserva'),
    path('cancelar-reserva/<int:reserva_id>/', CancelarReservaView.as_view(), name='cancelar_reserva'),
]