...
class Emprestimo(models.Model):
    ...
    leitor = models.ForeignKey(Leitor, on_delete=models.CASCADE, verbose_name="Quem Reservou")
    data_emprestimo = models.DateField(auto_now_add=True, verbose_name="Data da Reserva")
    data_devolucao = models.DateField(verbose_name="Data Prevista de Devolução", null=True, blank=True)
